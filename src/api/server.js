...
// MUST be defined BEFORE /api/teams/:teamNumber, otherwise Express matches "skills-batch"
// as the :teamNumber param and routes the request into the wrong handler.
